 ...
 <!-- top cards -->
            ...
            <div class="row">
                <div class="col-md-5 py-3 py-md-0">
                    <div class="card" style="background-color: #a9a9a926;">
                        <img src="{{ asset('images/topcard1.png') }}" alt="">
        ...
        <div class="banner">
            <div class="content">
                ...
                <a href="{{ route('products.index') }}"> <div id="bannerbtn"><button>SHOP NOW</button></div></a> 
            </div>
        </div>
        <!-- banner -->
        ...
        <div class="container" id="product-cards">
            ...
            <div class="row" style="margin-top: 30px;">
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p13.png') }}" alt="">
                        <div class="card-body">
                            <h3>Men T-Shirt</h3>
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p14.png') }}" alt="">
                        <div class="card-body">
                            <h3>Purple Heel</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p15.png') }}" alt="">
                        <div class="card-body">
                            <h3>Men Shoes</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p16.png') }}" alt="">
                        <div class="card-body">
                            <h3>Men Jacket</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
            ...
            <div class="row" style="margin-top: 30px;">
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p17.png') }}" alt="">
                        <div class="card-body">
                            <h3>Blue T-Shirt</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p18.png') }}" alt="">
                        <div class="card-body">
                            <h3>Girls Sandal</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p19.png') }}" alt="">
                        <div class="card-body">
                            <h3>Men Jacket</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
                ...
                <div class="col-md-3 py-3 py-md-0">
                    <div class="card">
                        <img src="{{ asset('images/p20.png') }}" alt="">
                        <div class="card-body">
                            <h3>Men T-SHirt</h3>
                            <p>Lorem ipsum dolor sit amet.</p>
                            <div class="star">
