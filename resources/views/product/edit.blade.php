            ...
            <div class="mx-auto px-3 md:px-6 lg:px-16">
                ...
                @else
                    {{-- <div class="alert alert-success">
                        ...
                        <p
                            class="bg-green-50 w-full p-3 space-y-1 rounded border border-green-400 text-xs text-green-400">
                ...
                <div
                    ...
                    <form class="w-full lg:px-8 px-4 py-3 my-form"
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-x-6 gap-y-2">
                            ...
                            <div class="col-span-1 flex flex-col mt-1">
                                <label for="category"
                                    class=" block text-sm font-medium leading-6 text-gray-900">Prodduct
                                    Category</label>
                            ...
                            <div class="md:col-span-2 col-span-1 grid md:grid-cols-3 grid-cols-1 gap-x-6 gap-y-2">
                                <div class="col-span-1 flex flex-col mt-1">
                                    <label for="price"
                                        class=" block text-sm font-medium leading-6 text-gray-900">Item
                                        Price</label>
